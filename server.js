...
function findDownloadedFile(prefix) {
  ...
  return matched
    ? path.join(DOWNLOAD_DIR, matched)
    : null;
...
(async () => {
  ...
  if (!ok) {
    ...
    console.log(
      "❌ Bot stopped because yt-dlp missing"
    );
